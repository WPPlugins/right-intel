...
class Ri_Schema {
	...
	public static function install() {
		...
		Ri_Flash::add('The Right Intel plugin has been successfully installed. To connect this blog to Right Intel, go to <a href="options-general.php?page=right_intel_settings">Settings &rsaquo; Right Intel</a>.');
	}
	
	public static function uninstall() {
		// empty the credentials table and let rightintel.com know
